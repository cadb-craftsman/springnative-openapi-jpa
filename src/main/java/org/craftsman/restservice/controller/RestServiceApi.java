...
public interface RestServiceApi {
	 ...
	 * PUT REST Service
	 */
	@Operation(summary = "Update a record", tags = { "RestService" })
	 ...
	 * POST REST Service
	 */
	@Operation(summary = "Create a record", tags = { "RestService" })
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "record created"),
			@ApiResponse(responseCode = "400", description = "invalid user operation"),
			@ApiResponse(responseCode = "404", description = "url not found") })
	 ...
	 * DELETE REST Service
	 */
	@Operation(summary = "Delete a record", tags = { "RestService" })
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "record created"),
			@ApiResponse(responseCode = "400", description = "invalid user operation"),
			@ApiResponse(responseCode = "404", description = "url not found") })
	 ...
	 * GET REST Service
	 */
	@Operation(summary = "Get all records", tags = { "RestService" })
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "record created"),
			@ApiResponse(responseCode = "400", description = "invalid user operation"),
			@ApiResponse(responseCode = "404", description = "url not found") })
	 ...
	 * GET REST Service
	 */
	@Operation(summary = "Get a record by id", tags = { "RestService" })
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "record created"),
			@ApiResponse(responseCode = "400", description = "invalid user operation"),
			@ApiResponse(responseCode = "404", description = "url not found") })
